...
def display():
    ...
    if zawieranie(tri3,tri1) or zawieranie(tri1,tri3) or zawieranie(tri2,tri1) or zawieranie(tri1,tri2) or zawieranie(tri3,tri2) or  zawieranie(tri2,tri3):
        txt+="" 
    txt += "\n";
    sys.stdout.write(txt);
    glFlush();
def Prosta_punkt(d,p):
    A=d[0]
    B=d[1]
    C=d[2]
    odleglosc= abs(A*p[0]+B*p[1]+C)/sqrt(A**2+B**2)
    return odleglosc
def prosta(p1,p2):
    ...
    C=-b
    return a,b,A,B,C
def ccAABBtoAABB(tri1,tri2 ):
    if (Prosta_punkt(prosta(tri1.a,tri1.b),tri2.c)) <= (Prosta_punkt(prosta(tri1.a,tri1.b),tri1.center)):
        if  tri2.c[1]>=min(tri1.a[1],tri1.b[1])  :
            if tri2.c[0]<=max(tri1.a[0],tri1.b[0]):
                return 1
...
def zderzenie(T1,T2):
    ...
    if a1[0]-a[0] !=0:
        x=(b[0]-b1[0])/(a1[0]-a[0])
        if a1[0]*x+b1[0] <=max(T2.a[1],T2.c[1]) and a1[0]*x+b1[0] >=min(T2.a[1],T2.c[1])   and x>=min(T2.a[0],T2.c[0]) and x<=max(T2.a[0],T2.c[0]):
            if a1[0]*x+b1[0] <=max(T1.a[1],T1.b[1]) and a1[0]*x+b1[0] >=min(T1.a[1],T1.b[1])  and x>=min(T1.a[0],T1.b[0]) and x<=max(T1.a[0],T1.b[0]):
                  
                    return 1
    if a1[1]-a[0] !=0:
        x=(b[0]-b1[1])/(a1[1]-a[0])
        if a1[1]*x+b1[1] <=max(T2.a[1],T2.b[1]) and a1[1]*x+b1[1] >=min(T2.a[1],T2.b[1])   and x>=min(T2.a[0],T2.b[0]) and x<=max(T2.a[0],T2.b[0]):
            if a1[1]*x+b1[1] <=max(T1.a[1],T1.b[1]) and a1[1]*x+b1[1] >=min(T1.a[1],T1.b[1])  and x>=min(T1.a[0],T1.b[0]) and x<=max(T1.a[0],T1.b[0]):
                
                    
                    return 1               
    if a1[1]-a[0] !=0:
        x=(b[0]-b1[2])/(a1[2]-a[0])
        if a1[2]*x+b1[2] <=max(T2.b[1],T2.c[1]) and a1[2]*x+b1[2] >=min(T2.b[1],T2.c[1])   and x>=min(T2.b[0],T2.c[0]) and x<=max(T2.b[0],T2.c[0]):
            if a1[2]*x+b1[2] <=max(T1.a[1],T1.b[1]) and a1[2]*x+b1[2] >=min(T1.a[1],T1.b[1])  and x>=min(T1.a[0],T1.b[0]) and x<=max(T1.a[0],T1.b[0]):
    ...
    if a1[0]-a[1] !=0:
        x=(b[1]-b1[0])/(a1[0]-a[1])
        if a1[0]*x+b1[0] <=max(T2.a[1],T2.c[1]) and a1[0]*x+b1[0] >=min(T2.a[1],T2.c[1])   and x>=min(T2.a[0],T2.c[0]) and x<=max(T2.a[0],T2.c[0]):
            if a1[0]*x+b1[0] <=max(T1.a[1],T1.c[1]) and a1[0]*x+b1[0] >=min(T1.a[1],T1.c[1])  and x>=min(T1.a[0],T1.c[0]) and x<=max(T1.a[0],T1.c[0]):
    ...
    if a1[1]-a[1] !=0:
        x=(b[1]-b1[1])/(a1[1]-a[1])
        if a1[1]*x+b1[1] <=max(T2.a[1],T2.b[1]) and a1[1]*x+b1[1] >=min(T2.a[1],T2.b[1])   and x>=min(T2.a[0],T2.b[0]) and x<=max(T2.a[0],T2.b[0]):
            if a1[1]*x+b1[1] <=max(T1.a[1],T1.c[1]) and a1[1]*x+b1[1] >=min(T1.a[1],T1.c[1])  and x>=min(T1.a[0],T1.c[0]) and x<=max(T1.a[0],T1.c[0]):
    ...
    if a1[2]-a[1] !=0:
        x=(b[1]-b1[2])/(a1[2]-a[1])
        if a1[2]*x+b1[2] <=max(T2.b[1],T2.c[1]) and a1[2]*x+b1[2] >=min(T2.b[1],T2.c[1])   and x>=min(T2.b[0],T2.c[0]) and x<=max(T2.b[0],T2.c[0]):
            if a1[2]*x+b1[2] <=max(T1.a[1],T1.c[1]) and a1[2]*x+b1[2] >=min(T1.a[1],T1.c[1])  and x>=min(T1.a[0],T1.c[0]) and x<=max(T1.a[0],T1.c[0]):
    ...
    if a1[0]-a[2] !=0:
        x=(b[2]-b1[0])/(a1[0]-a[2])
        if a1[0]*x+b1[0] <=max(T2.a[1],T2.c[1]) and a1[0]*x+b1[0] >=min(T2.a[1],T2.c[1])   and x>=min(T2.a[0],T2.c[0]) and x<=max(T2.a[0],T2.c[0]):
            if a1[0]*x+b1[0] <=max(T1.b[1],T1.c[1]) and a1[0]*x+b1[0] >=min(T1.b[1],T1.c[1])  and x>=min(T1.b[0],T1.c[0]) and x<=max(T1.b[0],T1.c[0]):
    ...
    if a1[1]-a[2] !=0:
        x=(b[2]-b1[1])/(a1[1]-a[2])
        if a1[1]*x+b1[1] <=max(T2.a[1],T2.b[1]) and a1[1]*x+b1[1] >=min(T2.a[1],T2.b[1])   and x>=min(T2.a[0],T2.b[0]) and x<=max(T2.a[0],T2.b[0]):
            if a1[1]*x+b1[1] <=max(T1.b[1],T1.c[1]) and a1[1]*x+b1[1] >=min(T1.b[1],T1.c[1])  and x>=min(T1.b[0],T1.c[0]) and x<=max(T1.b[0],T1.c[0]):
    ...
    if a1[2]-a[2] !=0:
        x=(b[2]-b1[2])/(a1[2]-a[2])
        if a1[2]*x+b1[2] <=max(T2.b[1],T2.c[1]) and a1[2]*x+b1[2] >=min(T2.b[1],T2.c[1])   and x>=min(T2.b[0],T2.c[0]) and x<=max(T2.b[0],T2.c[0]):
            if a1[2]*x+b1[2] <=max(T1.b[1],T1.c[1]) and a1[2]*x+b1[2] >=min(T1.b[1],T1.c[1])  and x>=min(T1.b[0],T1.c[0]) and x<=max(T1.b[0],T1.c[0]):
                                 
                    return 1  
    """            
    if (prosta(T1.a,T1.b)[2]*T1.center[0]+ prosta(T1.a,T1.b)[3]*T1.center[1]+ prosta(T1.a,T1.b)[4])*(prosta(T1.a,T1.b)[2]*T2.center[0]+ prosta(T1.a,T1.b)[3]*T2.center[1]+ prosta(T1.a,T1.b)[4])>0:
        if (prosta(T1.a,T1.c)[2]*T1.center[0]+ prosta(T1.a,T1.c)[3]*T1.center[1]+ prosta(T1.a,T1.c)[4])*(prosta(T1.a,T1.c)[2]*T2.center[0]+ prosta(T1.a,T1.c)[3]*T2.center[1]+ prosta(T1.a,T1.c)[4])>0:
            if(prosta(T1.b,T1.c)[2]*T1.center[0]+ prosta(T1.b,T1.c)[3]*T1.center[1]+ prosta(T1.b,T1.c)[4])*(prosta(T1.b,T1.c)[2]*T2.center[0]+ prosta(T1.b,T1.c)[3]*T2.center[1]+ prosta(T1.b,T1.c)[4])>0: 
                return 1"""
